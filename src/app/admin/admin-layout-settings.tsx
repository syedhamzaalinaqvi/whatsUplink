        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Header Scripts (for analytics, etc.)</FormLabel>
                  <FormControl>
                    <Textarea
                  ...
                  <p className='text-sm text-muted-foreground'>Add scripts like Google Analytics here. They will be injected into the page head. AdSense script is now handled automatically.</p>
                  <FormMessage />
                </FormItem>
              )}
            />
