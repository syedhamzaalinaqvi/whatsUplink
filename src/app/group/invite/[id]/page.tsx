...
// Note: This page is a client component because it manages the state
// for the "Submit Group" dialog. The data fetching itself happens
// on the server before the component is rendered, so performance is
